...
#define RFM22B_OK 0
#define RFM22B_ERR_LIMIT -1
#define RFM22B_ERR_CONFIG -2
#define RFM22B_ERR_BUSY -3
#define RFM22B_ERR_CONNECTION -4
...
extern RFM22B_Configs rfm22_confs; // config GFSK, 2.4kbs, 20kHz freq dev, 50kHz channel step, CRC off, no header
