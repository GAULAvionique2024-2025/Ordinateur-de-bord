                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            (connected && data.imuSensorState == SensorState.ok) ? '${data.imuAccVertical.toStringAsFixed(2)} m/s²' : '—',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts.inter(
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            (connected && data.imuSensorState == SensorState.ok) ? '${data.pitch.toStringAsFixed(1)}°' : '—',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts.inter(
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            (connected && data.imuSensorState == SensorState.ok) ? '${data.roll.toStringAsFixed(1)}°' : '—',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts.inter(
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            (connected && data.imuSensorState == SensorState.ok) ? '${data.yaw.toStringAsFixed(1)}°' : '—',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts.inter(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        (connected && data.barometerSensorState == SensorState.ok) ? '${data.barometerAlt.toStringAsFixed(2)} m' : '—',
                                        style: FlutterFlowTheme.of(context)
                                            .bodySmall
                                            .override(
                                              font: GoogleFonts.inter(
                                          ...
                                          Text(
                                          (connected && data.barometerSensorState == SensorState.ok) ? data.altitudeMslDisplay : '—',
                                          style: FlutterFlowTheme.of(context)
                                            .bodySmall
                                            .override(
                                              font: GoogleFonts.inter(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          color: connected
                                              ? ((data.kalmanAltitudeM != 0.0 || data.kalmanVelocityMS != 0.0)
                                                  ? FlutterFlowTheme.of(context).success
                                                  : FlutterFlowTheme.of(context).secondaryText)
                                              : FlutterFlowTheme.of(context).secondaryText,
                                          shape: BoxShape.circle,
