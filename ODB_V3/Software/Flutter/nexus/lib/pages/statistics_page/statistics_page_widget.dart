...
import 'package:nexus/widgets/gps_map_card.dart';
...
class _TopMetricsGrid extends StatelessWidget {
  const _TopMetricsGrid({required this.data, required this.connected});
...
class _ImuMetricsCard extends StatelessWidget {
  const _ImuMetricsCard({required this.data, required this.connected});
...
class _HighGMetricsCard extends StatelessWidget {
  const _HighGMetricsCard({required this.data, required this.connected});
...
class _BottomMetricsGrid extends StatelessWidget {
  const _BottomMetricsGrid({required this.data, required this.connected});
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: connected
                              ? ((data.kalmanAltitudeM != 0.0 ||
                                      data.kalmanVelocityMS != 0.0)
                                  ? FlutterFlowTheme.of(context).success
                                  : FlutterFlowTheme.of(context).secondaryText)
                              : FlutterFlowTheme.of(context).secondaryText,
                          shape: BoxShape.circle,
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        connected ? data.kalmanAltitudeDisplay : '—',
                        style:
                            FlutterFlowTheme.of(context).titleMedium.override(
                                  font: GoogleFonts.interTight(
                                    fontWeight: FontWeight.bold,
                      ...
                      Text(
                        connected ? data.kalmanVelocityDisplay : '—',
                        style: FlutterFlowTheme.of(context).bodySmall.override(
                              font: GoogleFonts.inter(
                                fontWeight: FlutterFlowTheme.of(context)
                                    .bodySmall
