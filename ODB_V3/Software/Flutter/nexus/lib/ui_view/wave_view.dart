        ...
        builder: (context, child) => new Stack(
          children: <Widget>[
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  color: NexusTheme.nearlyDarkBlue.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      NexusTheme.nearlyDarkBlue.withOpacity(0.2),
                      NexusTheme.nearlyDarkBlue.withOpacity(0.5)
                    ],
            ...
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  color: NexusTheme.nearlyDarkBlue,
                  gradient: LinearGradient(
                    colors: [
                      NexusTheme.nearlyDarkBlue.withOpacity(0.4),
                      NexusTheme.nearlyDarkBlue
                    ],
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight,
                  ),
            ...
            Positioned(
              ...
              child: new ScaleTransition(
                ...
                child: Container(
                  ...
                  height: 2,
                  decoration: BoxDecoration(
                    color: NexusTheme.white.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: new Transform(
                ...
                child: Container(
                  ...
                  height: 4,
                  decoration: BoxDecoration(
                    color: NexusTheme.white.withOpacity(
            ...
            Column(
              children: <Widget>[
                AspectRatio(
                  aspectRatio: 1,
                  child: Image.asset("assets/nexus_app/bottle.png"),
                ),
              ],
            )
          ],
