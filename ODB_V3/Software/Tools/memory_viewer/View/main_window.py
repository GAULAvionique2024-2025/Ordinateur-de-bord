...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        try:
            with open(resource_path("Ressources", "style.qss"), "r", encoding="utf-8") as f:
    ...
    def draw_sunburst_chart(self):
        ...
        base_url = QtCore.QUrl.fromLocalFile(resource_path("Ressources") + "/")
        self.web_view.setHtml(html, base_url)

    def on_select_flight(self):
        if not self.flight_list.selectedIndexes() or not self.parser:
            return
