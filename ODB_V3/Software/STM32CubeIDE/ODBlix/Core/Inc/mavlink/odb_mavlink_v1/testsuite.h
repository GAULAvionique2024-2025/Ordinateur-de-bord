...
static void mavlink_test_rocket_telemetry(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_rocket_telemetry_t packet_in = {
        963497464,45.0,73.0,101.0,129.0,157.0,185.0,213.0,241.0,269.0,297.0,325.0,353.0,381.0,409.0,437.0,465.0,493.0,521.0,963501416,963501624,963501832,633.0,661.0,689.0,717.0,22643,22747,22851,22955,23059,219,30,97
    };
    mavlink_rocket_telemetry_t packet1, packet2;
        ...
        packet1.altitude_msl_m = packet_in.altitude_msl_m;
        packet1.pressure_pa = packet_in.pressure_pa;
    ...
    mavlink_msg_rocket_telemetry_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_rocket_telemetry_pack(system_id, component_id, &msg , packet1.time_boot_ms , packet1.system_states , packet1.event_states , packet1.mission_state , packet1.battery_mv , packet1.roll , packet1.pitch , packet1.yaw , packet1.imu_acc_x , packet1.imu_acc_y , packet1.imu_acc_z , packet1.imu_gyro_x , packet1.imu_gyro_y , packet1.imu_gyro_z , packet1.imu_mag_x , packet1.imu_mag_y , packet1.imu_mag_z , packet1.altitude_msl_m , packet1.pressure_pa , packet1.temp_celsius , packet1.highg_acc_x , packet1.highg_acc_y , packet1.highg_acc_z , packet1.gps_fix , packet1.lat , packet1.lon , packet1.gps_alt , packet1.vel , packet1.cog , packet1.satellites_nb , packet1.imu_acc_vertical , packet1.highg_acc_vertical , packet1.kalman_z , packet1.kalman_v );
    mavlink_msg_rocket_telemetry_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_rocket_telemetry_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_boot_ms , packet1.system_states , packet1.event_states , packet1.mission_state , packet1.battery_mv , packet1.roll , packet1.pitch , packet1.yaw , packet1.imu_acc_x , packet1.imu_acc_y , packet1.imu_acc_z , packet1.imu_gyro_x , packet1.imu_gyro_y , packet1.imu_gyro_z , packet1.imu_mag_x , packet1.imu_mag_y , packet1.imu_mag_z , packet1.altitude_msl_m , packet1.pressure_pa , packet1.temp_celsius , packet1.highg_acc_x , packet1.highg_acc_y , packet1.highg_acc_z , packet1.gps_fix , packet1.lat , packet1.lon , packet1.gps_alt , packet1.vel , packet1.cog , packet1.satellites_nb , packet1.imu_acc_vertical , packet1.highg_acc_vertical , packet1.kalman_z , packet1.kalman_v );
    mavlink_msg_rocket_telemetry_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_rocket_telemetry_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_rocket_telemetry_send(MAVLINK_COMM_1 , packet1.time_boot_ms , packet1.system_states , packet1.event_states , packet1.mission_state , packet1.battery_mv , packet1.roll , packet1.pitch , packet1.yaw , packet1.imu_acc_x , packet1.imu_acc_y , packet1.imu_acc_z , packet1.imu_gyro_x , packet1.imu_gyro_y , packet1.imu_gyro_z , packet1.imu_mag_x , packet1.imu_mag_y , packet1.imu_mag_z , packet1.altitude_msl_m , packet1.pressure_pa , packet1.temp_celsius , packet1.highg_acc_x , packet1.highg_acc_y , packet1.highg_acc_z , packet1.gps_fix , packet1.lat , packet1.lon , packet1.gps_alt , packet1.vel , packet1.cog , packet1.satellites_nb , packet1.imu_acc_vertical , packet1.highg_acc_vertical , packet1.kalman_z , packet1.kalman_v );
    mavlink_msg_rocket_telemetry_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
