...
typedef struct __mavlink_rocket_telemetry_t {
 ...
 int16_t imu_gyro_x; /*< [cm/s/s] IMU Gyro X in centimeters per second squared.*/
 int16_t imu_gyro_y; /*< [cm/s/s] IMU Gyro Y in centimeters per second squared.*/
 int16_t imu_gyro_z; /*< [cm/s/s] IMU Gyro Z in centimeters per second squared.*/
 int16_t high_g_acc_x; /*< [cm/s/s] High-G Acceleration X in centimeters per second squared.*/
 int16_t high_g_acc_y; /*< [cm/s/s] High-G Acceleration Y in centimeters per second squared.*/
 int16_t high_g_acc_z; /*< [cm/s/s] High-G Acceleration Z in centimeters per second squared.*/
...
#define MAVLINK_MSG_ID_ROCKET_TELEMETRY_LEN 56
#define MAVLINK_MSG_ID_ROCKET_TELEMETRY_MIN_LEN 56
#define MAVLINK_MSG_ID_200_LEN 56
#define MAVLINK_MSG_ID_200_MIN_LEN 56

#define MAVLINK_MSG_ID_ROCKET_TELEMETRY_CRC 109
#define MAVLINK_MSG_ID_200_CRC 109
...
#define MAVLINK_MESSAGE_INFO_ROCKET_TELEMETRY { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_rocket_telemetry_t, time_boot_ms) }, \
         ...
         { "imu_acc_x", NULL, MAVLINK_TYPE_INT16_T, 0, 28, offsetof(mavlink_rocket_telemetry_t, imu_acc_x) }, \
         { "imu_acc_y", NULL, MAVLINK_TYPE_INT16_T, 0, 30, offsetof(mavlink_rocket_telemetry_t, imu_acc_y) }, \
         { "imu_acc_z", NULL, MAVLINK_TYPE_INT16_T, 0, 32, offsetof(mavlink_rocket_telemetry_t, imu_acc_z) }, \
         { "imu_gyro_x", NULL, MAVLINK_TYPE_INT16_T, 0, 34, offsetof(mavlink_rocket_telemetry_t, imu_gyro_x) }, \
         { "imu_gyro_y", NULL, MAVLINK_TYPE_INT16_T, 0, 36, offsetof(mavlink_rocket_telemetry_t, imu_gyro_y) }, \
         { "imu_gyro_z", NULL, MAVLINK_TYPE_INT16_T, 0, 38, offsetof(mavlink_rocket_telemetry_t, imu_gyro_z) }, \
         { "high_g_acc_x", NULL, MAVLINK_TYPE_INT16_T, 0, 40, offsetof(mavlink_rocket_telemetry_t, high_g_acc_x) }, \
         { "high_g_acc_y", NULL, MAVLINK_TYPE_INT16_T, 0, 42, offsetof(mavlink_rocket_telemetry_t, high_g_acc_y) }, \
         { "high_g_acc_z", NULL, MAVLINK_TYPE_INT16_T, 0, 44, offsetof(mavlink_rocket_telemetry_t, high_g_acc_z) }, \
         { "system_states", NULL, MAVLINK_TYPE_UINT16_T, 0, 46, offsetof(mavlink_rocket_telemetry_t, system_states) }, \
         { "battery_mv", NULL, MAVLINK_TYPE_UINT16_T, 0, 48, offsetof(mavlink_rocket_telemetry_t, battery_mv) }, \
         { "vel", NULL, MAVLINK_TYPE_UINT16_T, 0, 50, offsetof(mavlink_rocket_telemetry_t, vel) }, \
         { "cog", NULL, MAVLINK_TYPE_UINT16_T, 0, 52, offsetof(mavlink_rocket_telemetry_t, cog) }, \
         { "gps_fix", NULL, MAVLINK_TYPE_UINT8_T, 0, 54, offsetof(mavlink_rocket_telemetry_t, gps_fix) }, \
         { "satellites_nb", NULL, MAVLINK_TYPE_UINT8_T, 0, 55, offsetof(mavlink_rocket_telemetry_t, satellites_nb) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_ROCKET_TELEMETRY { \
 ...
 * @param imu_gyro_x [cm/s/s] IMU Gyro X in centimeters per second squared.
 * @param imu_gyro_y [cm/s/s] IMU Gyro Y in centimeters per second squared.
 * @param imu_gyro_z [cm/s/s] IMU Gyro Z in centimeters per second squared.
 * @param high_g_acc_x [cm/s/s] High-G Acceleration X in centimeters per second squared.
 * @param high_g_acc_y [cm/s/s] High-G Acceleration Y in centimeters per second squared.
 * @param high_g_acc_z [cm/s/s] High-G Acceleration Z in centimeters per second squared.
                               ...
                               uint32_t time_boot_ms, int32_t lat, int32_t lon, int32_t gps_alt, float pressure_hpa, int16_t roll, int16_t pitch, int16_t yaw, int16_t temp_celsius, int16_t imu_acc_x, int16_t imu_acc_y, int16_t imu_acc_z, int16_t imu_gyro_x, int16_t imu_gyro_y, int16_t imu_gyro_z, int16_t high_g_acc_x, int16_t high_g_acc_y, int16_t high_g_acc_z, uint16_t system_states, uint16_t battery_mv, uint16_t vel, uint16_t cog, uint8_t gps_fix, uint8_t satellites_nb)
{
    ...
    _mav_put_int16_t(buf, 28, imu_acc_x);
    _mav_put_int16_t(buf, 30, imu_acc_y);
    _mav_put_int16_t(buf, 32, imu_acc_z);
    _mav_put_int16_t(buf, 34, imu_gyro_x);
    _mav_put_int16_t(buf, 36, imu_gyro_y);
    _mav_put_int16_t(buf, 38, imu_gyro_z);
    _mav_put_int16_t(buf, 40, high_g_acc_x);
    _mav_put_int16_t(buf, 42, high_g_acc_y);
    _mav_put_int16_t(buf, 44, high_g_acc_z);
    _mav_put_uint16_t(buf, 46, system_states);
    _mav_put_uint16_t(buf, 48, battery_mv);
    _mav_put_uint16_t(buf, 50, vel);
    _mav_put_uint16_t(buf, 52, cog);
    _mav_put_uint8_t(buf, 54, gps_fix);
    _mav_put_uint8_t(buf, 55, satellites_nb);
    ...
    packet.high_g_acc_x = high_g_acc_x;
    packet.high_g_acc_y = high_g_acc_y;
    packet.high_g_acc_z = high_g_acc_z;
 ...
 *
 * @return [cm/s/s] IMU Gyro X in centimeters per second squared.
 */
static inline int16_t mavlink_msg_rocket_telemetry_get_imu_gyro_x(const mavlink_message_t* msg)
{
 ...
 *
 * @return [cm/s/s] IMU Gyro Y in centimeters per second squared.
 */
static inline int16_t mavlink_msg_rocket_telemetry_get_imu_gyro_y(const mavlink_message_t* msg)
{
 ...
 *
 * @return [cm/s/s] IMU Gyro Z in centimeters per second squared.
 */
static inline int16_t mavlink_msg_rocket_telemetry_get_imu_gyro_z(const mavlink_message_t* msg)
{
    return _MAV_RETURN_int16_t(msg,  38);
}

/**
 * @brief Get field high_g_acc_x from rocket_telemetry message
 *
 * @return [cm/s/s] High-G Acceleration X in centimeters per second squared.
 */
static inline int16_t mavlink_msg_rocket_telemetry_get_high_g_acc_x(const mavlink_message_t* msg)
{
    return _MAV_RETURN_int16_t(msg,  40);
}

/**
 * @brief Get field high_g_acc_y from rocket_telemetry message
 *
 * @return [cm/s/s] High-G Acceleration Y in centimeters per second squared.
 */
static inline int16_t mavlink_msg_rocket_telemetry_get_high_g_acc_y(const mavlink_message_t* msg)
{
    return _MAV_RETURN_int16_t(msg,  42);
}

/**
 * @brief Get field high_g_acc_z from rocket_telemetry message
 *
 * @return [cm/s/s] High-G Acceleration Z in centimeters per second squared.
 */
static inline int16_t mavlink_msg_rocket_telemetry_get_high_g_acc_z(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_rocket_telemetry_decode(const mavlink_message_t* msg, mavlink_rocket_telemetry_t* rocket_telemetry)
{
    ...
    rocket_telemetry->high_g_acc_x = mavlink_msg_rocket_telemetry_get_high_g_acc_x(msg);
    rocket_telemetry->high_g_acc_y = mavlink_msg_rocket_telemetry_get_high_g_acc_y(msg);
    rocket_telemetry->high_g_acc_z = mavlink_msg_rocket_telemetry_get_high_g_acc_z(msg);
