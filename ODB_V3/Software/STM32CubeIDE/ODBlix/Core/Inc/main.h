...
#define EXTEND_USART3_TX_Pin GPIO_PIN_10
#define EXTEND_USART3_TX_GPIO_Port GPIOB
#define EXTEND_USART3_RX_Pin GPIO_PIN_11
#define EXTEND_USART3_RX_GPIO_Port GPIOB
#define EXTEND_SPI2_CLK_Pin GPIO_PIN_13
#define EXTEND_SPI2_CLK_GPIO_Port GPIOB
#define EXTEND_SPI2_MISO_Pin GPIO_PIN_14
#define EXTEND_SPI2_MISO_GPIO_Port GPIOB
#define EXTEND_SPI2_MOSI_Pin GPIO_PIN_15
#define EXTEND_SPI2_MOSI_GPIO_Port GPIOB
#define EXTEND_SPI2_CS1_Pin GPIO_PIN_8
#define EXTEND_SPI2_CS1_GPIO_Port GPIOD
#define EXTEND_SPI2_CS2_Pin GPIO_PIN_9
#define EXTEND_SPI2_CS2_GPIO_Port GPIOD
#define EXTEND_SPI2_CS3_Pin GPIO_PIN_10
#define EXTEND_SPI2_CS3_GPIO_Port GPIOD
#define BUZZER_PWM_Pin GPIO_PIN_12
#define BUZZER_PWM_GPIO_Port GPIOD
#define GPS_FUNCT_2_Pin GPIO_PIN_2
#define GPS_FUNCT_2_GPIO_Port GPIOG
#define GPS_FUNCT_1_Pin GPIO_PIN_3
#define GPS_FUNCT_1_GPIO_Port GPIOG
...
#define EXTEND_CAN1_RX_Pin GPIO_PIN_0
#define EXTEND_CAN1_RX_GPIO_Port GPIOD
#define EXTEND_CAN1_TX_Pin GPIO_PIN_1
#define EXTEND_CAN1_TX_GPIO_Port GPIOD
#define EXTEND_IO1_Pin GPIO_PIN_2
#define EXTEND_IO1_GPIO_Port GPIOD
#define EXTEND_IO2_Pin GPIO_PIN_3
#define EXTEND_IO2_GPIO_Port GPIOD
#define EXTEND_IO3_Pin GPIO_PIN_4
#define EXTEND_IO3_GPIO_Port GPIOD
#define EXTEND_IO4_Pin GPIO_PIN_5
#define EXTEND_IO4_GPIO_Port GPIOD
