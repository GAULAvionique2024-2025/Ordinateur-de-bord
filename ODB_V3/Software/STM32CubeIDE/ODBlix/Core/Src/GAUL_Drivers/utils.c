...
void Telemetry_SendRocketData(rfd900x_t *rfd_dev, odb_modem_id_t modem_id, odb_data *data, uint32_t current_time_ms) {
    ...
    mavlink_msg_rocket_telemetry_pack(
		...
		(int16_t)(data->imu_gyro_x * 100.0f),
		(int16_t)(data->imu_gyro_y * 100.0f),
		(int16_t)(data->imu_gyro_z * 100.0f),
		(int16_t)(data->highg_acc_x * 100.0f),
		(int16_t)(data->highg_acc_y * 100.0f),
		(int16_t)(data->highg_acc_z * 100.0f),
        data->system_states,
        data->battery_mv,
        data->vel,
        data->cog,
