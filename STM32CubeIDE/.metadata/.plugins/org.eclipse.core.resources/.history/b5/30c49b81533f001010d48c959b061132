...
int main(void)
{
  ...
  rfm22b.int_pin = 1;
  rfm22b.snd_port = GPIOC;
  rfm22b.snd_pin = 0;
  SPI_InitPeriph(SPI1, SPI_BAUDRATE_4);
  RFM22B_Init(SPI1, &rfm22b, &rfm22_confs, 0);
  uint8_t dataToSend[8] = {0x00};
  */
  /* USER CODE END 2 */
...
static void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_SetOutputPin(GPIOA, RFM_CS_Pin|ICM_CS_Pin);
  ...
  /**/
  LL_GPIO_ResetOutputPin(CriticalLEDEnable_GPIO_Port, CriticalLEDEnable_Pin);
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart) {
  L76LM33_RxCallback(huart, &l76lm33);
}
/* USER CODE END 4 */
