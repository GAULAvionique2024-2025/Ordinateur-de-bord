...
#define MEM_MISO_Pin LL_GPIO_PIN_5
#define MEM_MISO_GPIO_Port GPIOE
#define Enable7v4_Pin LL_GPIO_PIN_14
#define Enable7v4_GPIO_Port GPIOC
#define nPYROS_Test_Pin LL_GPIO_PIN_2
#define nPYROS_Test_GPIO_Port GPIOF
#define PYROS_Bluetooth_Pin LL_GPIO_PIN_3
#define PYROS_Bluetooth_GPIO_Port GPIOF
#define PYROS_MainODB_Pin LL_GPIO_PIN_9
#define PYROS_MainODB_GPIO_Port GPIOF
#define PYROS_DrogueODB_Pin LL_GPIO_PIN_10
#define PYROS_DrogueODB_GPIO_Port GPIOF
#define RFM_SDN_Pin LL_GPIO_PIN_0
#define RFM_SDN_GPIO_Port GPIOC
#define RFM_NIRQ_Pin LL_GPIO_PIN_1
#define RFM_NIRQ_GPIO_Port GPIOC
#define AN_7v4_Pin LL_GPIO_PIN_3
#define AN_7v4_GPIO_Port GPIOC
#define RFM_CS_Pin LL_GPIO_PIN_2
#define RFM_CS_GPIO_Port GPIOA
#define ICM_INT_Pin LL_GPIO_PIN_3
#define ICM_INT_GPIO_Port GPIOA
#define ICM_CS_Pin LL_GPIO_PIN_4
#define ICM_CS_GPIO_Port GPIOA
#define ICM_RFM_SCK_Pin LL_GPIO_PIN_5
#define ICM_RFM_SCK_GPIO_Port GPIOA
#define ICM_RFM_MISO_Pin LL_GPIO_PIN_6
#define ICM_RFM_MISO_GPIO_Port GPIOA
#define ICM_RFM_MOSI_Pin LL_GPIO_PIN_7
#define ICM_RFM_MOSI_GPIO_Port GPIOA
#define PYROS_ADC_Pin LL_GPIO_PIN_4
#define PYROS_ADC_GPIO_Port GPIOC
#define AN_3v7_Pin LL_GPIO_PIN_5
#define AN_3v7_GPIO_Port GPIOC
#define MEM_SCLK_Pin LL_GPIO_PIN_0
#define MEM_SCLK_GPIO_Port GPIOB
#define MEM_CS_Pin LL_GPIO_PIN_1
#define MEM_CS_GPIO_Port GPIOB
#define BUZZER_PWM_Pin LL_GPIO_PIN_9
#define BUZZER_PWM_GPIO_Port GPIOE
#define BARO_SCK_Pin LL_GPIO_PIN_12
#define BARO_SCK_GPIO_Port GPIOE
#define BARO_MISO_Pin LL_GPIO_PIN_13
#define BARO_MISO_GPIO_Port GPIOE
#define BARO_MOSI_Pin LL_GPIO_PIN_14
#define BARO_MOSI_GPIO_Port GPIOE
#define IO_Camera2_Pin LL_GPIO_PIN_13
#define IO_Camera2_GPIO_Port GPIOB
#define IO_Camera1_Pin LL_GPIO_PIN_14
#define IO_Camera1_GPIO_Port GPIOB
#define RFD_TX_Pin LL_GPIO_PIN_6
#define RFD_TX_GPIO_Port GPIOC
#define RFD_RX_Pin LL_GPIO_PIN_7
#define RFD_RX_GPIO_Port GPIOC
#define CriticalLEDEnable_Pin LL_GPIO_PIN_8
#define CriticalLEDEnable_GPIO_Port GPIOA
#define GPS_TX_Pin LL_GPIO_PIN_9
#define GPS_TX_GPIO_Port GPIOA
#define GPS_RX_Pin LL_GPIO_PIN_10
#define GPS_RX_GPIO_Port GPIOA
#define USBData__Pin LL_GPIO_PIN_11
#define USBData__GPIO_Port GPIOA
#define USBData_A12_Pin LL_GPIO_PIN_12
...
#define BT_TX_Pin LL_GPIO_PIN_5
#define BT_TX_GPIO_Port GPIOD
#define BT_RX_Pin LL_GPIO_PIN_6
#define BT_RX_GPIO_Port GPIOD
#define RFD_RTS_Pin LL_GPIO_PIN_12
#define RFD_RTS_GPIO_Port GPIOG
#define SYS_SWO_Pin LL_GPIO_PIN_3
#define SYS_SWO_GPIO_Port GPIOB
#define MEM_MOSI_Pin LL_GPIO_PIN_8
