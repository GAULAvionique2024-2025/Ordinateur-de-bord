...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, RFM_CS_Pin|ICM_INT_Pin|CriticalLEDEnable_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : MEM_MISO_Pin */
  ...
  /*Configure GPIO pins : RFM_CS_Pin ICM_INT_Pin CriticalLEDEnable_Pin */
  GPIO_InitStruct.Pin = RFM_CS_Pin|ICM_INT_Pin|CriticalLEDEnable_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : MEM_SCLK_Pin MEM_CS_Pin MEM_MOSI_Pin */
  GPIO_InitStruct.Pin = MEM_SCLK_Pin|MEM_CS_Pin|MEM_MOSI_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStruct.Alternate = GPIO_AF6_SPI5;
  ...
  /*Configure GPIO pins : USBData__Pin USBData_A12_Pin */
  GPIO_InitStruct.Pin = USBData__Pin|USBData_A12_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
