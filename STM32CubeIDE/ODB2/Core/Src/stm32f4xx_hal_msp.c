...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    PC5     ------> ADC1_IN15
    */
    GPIO_InitStruct.Pin = AN_7v4_Pin|PYROS_ADC_Pin|AN_3v7_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PC5     ------> ADC1_IN15
    */
    HAL_GPIO_DeInit(GPIOC, AN_7v4_Pin|PYROS_ADC_Pin|AN_3v7_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==SPI1)
  {
    ...
    */
    ...
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI1;
    HAL_GPIO_Init(ICM_RFM_MISO_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(hspi->Instance==SPI4)
  {
    ...
    */
    ...
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI4;
    HAL_GPIO_Init(BARO_MISO_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, ICM_RFM_SCK_Pin|ICM_RFM_MISO_Pin|ICM_RFM_MOSI_Pin);
  ...
  else if(hspi->Instance==SPI4)
  {
    ...
    PE14     ------> SPI4_MOSI
    */
    HAL_GPIO_DeInit(GPIOE, BARO_SCK_Pin|BARO_MISO_Pin|BARO_MOSI_Pin);
  ...
  else if(hspi->Instance==SPI5)
  {
    ...
    PB8     ------> SPI5_MOSI
    */
    HAL_GPIO_DeInit(MEM_MISO_GPIO_Port, MEM_MISO_Pin);

    HAL_GPIO_DeInit(GPIOB, MEM_SCLK_Pin|MEM_MOSI_Pin);
